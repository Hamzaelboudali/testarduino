...
def send_whatsapp_alert():
    account_sid = 'SID Twilio'  # Remplacez par votre account SID Twilio
    auth_token = 'token authentification Twilio'  # Remplacez par votre token d'authentification Twilio
    ...
    if request.method == "GET":
        ...
        if serial.is_valid():
            ...
            if new_data.temp > 10:  # Remplacez 10 par votre seuil
                # Alerte Telegram
                telegram_token = 'token Telegram'  # Remplacez par votre token Telegram
                chat_id = 'chat ID'  # Remplacez par votre chat ID
